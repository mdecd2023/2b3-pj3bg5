...
\makebox[5cm][s]{班\qquad 級：\quad 四\quad 設\quad 二\quad 乙}\\[6pt]
\makebox[5cm][s]{學\qquad 生：\quad 梁\quad 琇\quad 婷\quad(41023202)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}張\quad 詠\quad 淇\quad(41023212)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}陳\quad 濬\quad 祺\quad(41023229)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}廖\quad 旭\quad 宏\quad(41023242)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}鄭\quad 煜\quad 橙\quad(41023252)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}吳\quad 圳\quad 吉\quad(40923115)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}林\quad 祐\quad 詮\quad(40923130)}\\[6pt]
\makebox[5cm][s]{\hspace{36.5mm}詹\quad 侑\quad 儒\quad(40923235)}\\[6pt]
\end{flushleft}
\vspace{6em}
...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二乙\enspace 41023202 梁琇婷}\\ \underline{四設二乙\enspace 41023212\enspace 張詠淇}\\ \underline{四設二乙\enspace 41023229\enspace 陳濬祺}\\ \underline{四設二乙\enspace 41023242\enspace 廖旭宏}\\ \underline{四設二乙\enspace 41023252\enspace 鄭煜橙}\\ \underline{四設三乙\enspace 40923115\enspace 吳圳吉}\\ \underline{四設三乙\enspace 40923130\enspace 林祐詮}\\ \underline{四設三乙\enspace 40923235\enspace 詹侑儒}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
...
%=-------------作者簡介-----------------=%
   ...
   \vspace{2em}
	...
	\begin{figure}
	\includegraphics[width=1.15in]{11111}  %作者照片
    \end{figure}
    \end{textblock}}
...
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{11111} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
